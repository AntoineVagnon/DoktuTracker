...
async function fixDuplicateUser() {
  ...
  try {
    // Step 1: Restore correct email to original user
    console.log('1. Restoring correct email to original user (ID 39)...');
    ...
    // Step 2: Delete duplicate user
    console.log('\n2. Removing duplicate user (ID 50)...');
    ...
    console.log('\n✅ All fixed! You can now log in with james.rodriguez@doktu.com');
