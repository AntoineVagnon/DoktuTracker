...
- **Core Features**:
    ...
    - **Email System with Calendar Integration (Aug 2025)**: Comprehensive email notification system with ICS calendar file attachments for all appointment confirmations. Patients and doctors receive .ics files to easily add appointments to their calendar applications (Outlook, Google Calendar, etc.). Includes proper time zone handling and appointment details.
