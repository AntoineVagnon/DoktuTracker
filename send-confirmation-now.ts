...
async function sendConfirmationNow() {
  try {
    ...
    console.log(`   From: doktu@doktu.co`);
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  <div style="background-color: #f8f9fa; padding: 20px; border-radius: 10px;">
    ...
    <div style="background-color: white; padding: 15px; border-radius: 5px; margin: 20px 0;">
      ...
      <p><strong>Montant payé :</strong> ${appointment.price || '35.00'} €</p>
      <p><strong>Numéro de confirmation :</strong> #${appointment.id}</p>
    </div>
    
    <div style="background-color: #fff3cd; padding: 15px; border-radius: 5px; margin: 20px 0;">
      <h3 style="color: #856404; margin-top: 0;">Comment vous préparer</h3>
      <ul style="color: #856404;">
        ...
        <li>Le lien de connexion vous sera envoyé 30 minutes avant le rendez-vous</li>
      </ul>
    </div>
    ...
    if (success) {
      ...
      console.log("📨 Veuillez vérifier votre boîte de réception à " + patient.email);
    } else {
      console.log("❌ L'envoi a échoué - vérifiez que doktu@doktu.co est vérifié dans SendGrid");
    }
